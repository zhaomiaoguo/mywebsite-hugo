...
各位老师，大家好。我是王成军，来自南京大学新闻传播学院，我的述职报告的题目是《计算社会科学视角下的传播学研究》。具体包括四个部分，分别是：个人简介、研究成果、教学服务、工作计划。

我本科和硕士分别毕业于兰州大学和北京大学，2014年毕业于香港城市大学媒体与传播系，获传播学博士学位。9月加入南京大学新闻传播学院，担任奥美数据科学实验室主任，计算传播学实验中心成员、互联网挖掘实验室研究员。我的主要研究兴趣聚焦于计算传播学，具体包括：注意力流动网络、公共讨论，最近在做团队科学的研究。更多信息参见我的个人网站。

接下来介绍我的研究成果，英文发表包括：四篇SCI/SSCI一作或通讯作者论文、两篇SCI/SSCI三作论文、十五篇国际会议论文。其中，包括两篇自然出版集团期刊Scientific reports，一篇Physica A， 还有一篇Cyberpyschology。期刊的影响因子均较高，其中Cyberpyschology在2013年传播学72本国际期刊中排名第四。

人类传播行为的相关数据及其互动可能变革我们对于人类群体行为的理解。这是计算社会科学的领军人物Ducan Watts在2007年发表于Nature期刊的文章所提出的洞见，Watts认为社会科学将成为21世纪的科学，2009年Lazer， Pentland等一批研究者在Science上发表题为计算社会科学的文章。与之类似，在人文学科研究领域，也产生了“数字人文”的研究范式。

如何采用计算社会科学的视角理解传播现象？基于这一视角，我发表了几篇关于计算传播学的论文，确立了计算传播学的概念和目标。在这个过程中，参与翻译了一本使用Python进行社会网络分析的书籍，合著了《社交网络上的计算传播学》一书。

最近三年发表的论文主要是关于注意力流动网络的。处于注意力经济时代，人们每天都会接触大量的信息。研究个体和群体的注意力流动具有重要的理论和应用价值。逐渐确立了一种新的研究策略：即使用大规模数据，简单的计算机算法和物理学模型，回答社会科学的大问题。采用用这种方法，分析了百度贴吧用户的注意力流动中的标度现象，社交新闻网站的群体注意力流动的方向，北京移动用户的线上注意力流动和在物理空间的移动行为的关联，推特上的关于社会运动的公众讨论。

我申请了几个研究项目，主持了国家社会科学基金青年项目、博士后科学基金面上项目，并参与了一个自然科学基金项目。


在教学服务方面，也主要围绕建设计算传播学社区展开，为研究生和本科生课设《计算传播》、《数据新闻》、《计算广告》相关课程。为更好建设计算传播学社区，2014年发起建立了计算传播网，2015年参与创建了计算传播学实验中心，7月主办了集智注意力科学年会，2016年9月主办了第一届计算传播学论坛。2017年该会议发展为计算传播学年会，为期3天，并包括一个两天的工作坊。我还担任 IJPOR \ CHB \ JASIST \ICA 新闻与传播研究、新闻大学等期刊的的reviewer。我开发了两个python软件包iching和scholarnetwork， 一个R软件包networkdiffusion。

未来计划在教学方面：继续开设《数据新闻》、《计算传播》等课程。并将于2017年，开设233改革硕士品牌课程 《大数据挖掘与分析》；在科研方面，定位于定位高影响因子期刊的英文论文、兼顾中文论文；出版《计算传播学导论》一书。在社会服务方面：继续举办“计算传播学工作坊和年会”，积极参与学校智库和双创建设。
